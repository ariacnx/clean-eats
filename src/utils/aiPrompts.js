...
export const getDishImagePrompt = (dishName) => {
  ...
  return `A minimalist line drawing, rendered in dark brown ink on textured, cream-colored paper, showing ${safeName} dish. The sketch features flowing, hand-drawn lines depicting several slices of the dish. The style is elegant and sparse, suitable for a fine dining menu illustration. The image should be square (1:1 aspect ratio) with the dish centered.`;
};
